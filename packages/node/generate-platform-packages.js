 ...
 *
 * Example:
 *   node generate-platform-packages.js 0.9.44 ./artifacts ./platform-packages
 */
...
function main() {
  ...
  if (args.length < 3) {
    ...
    console.error('Example: node generate-platform-packages.js 0.9.44 ./artifacts ./platform-packages');
    process.exit(1);
  }
  ...
  if (!/^\d+\.\d+\.\d+$/.test(version)) {
    ...
    console.error('Version must be in semver format (e.g., 0.9.44)');
    process.exit(1);
  }
